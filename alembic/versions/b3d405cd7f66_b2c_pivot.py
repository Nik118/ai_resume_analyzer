...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_job_targets_resume_id'), 'job_targets', ['resume_id'], unique=False)
    ...
    op.create_index(op.f('ix_resume_versions_email'), 'resume_versions', ['email'], unique=False)
    op.create_index(op.f('ix_resume_versions_filename'), 'resume_versions', ['filename'], unique=False)
    op.create_index(op.f('ix_resume_versions_id'), 'resume_versions', ['id'], unique=False)
    op.create_index(op.f('ix_resume_versions_phone'), 'resume_versions', ['phone'], unique=False)
